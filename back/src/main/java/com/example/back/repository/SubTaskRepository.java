...
public interface SubTaskRepository extends JpaRepository<SubTask,Long> {
    ...
    Page<SubTask> getAllSubTaskById(Long id, String name, String priority, Long idStatus, Pageable pageable, @Param("createTime") LocalDate createTime, @Param("updateTime") LocalDate updateTime);
}
